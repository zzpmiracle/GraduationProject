...
DenseNet_file_path = './trained_models/denseNet-last-96.6.hdf5'
    ...
    while l < len_data-l_length:
        ...
        if result<0.5:
            ...
            if conti_flag:
                ...
                conti_flag = False
                f.writelines('{}:{} to {}:{} happened an event!\n'.format(begin_time_min, begin_time_sec, end_time_min, end_time_sec))
